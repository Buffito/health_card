...
public class Config {
    ...
    public static String DeviceKeyIdentifier = "dCkmbwofz2Gdfoz1BGK7aK8WJ8shbT8B";
    ...
    public static FaceTecCustomization retrieveConfigurationWizardCustomization() {
        ...
        int borderColor = Color.parseColor("#30bd68");
        int ovalColor = Color.parseColor("#30bd68");
        int dualSpinnerColor = Color.parseColor("#30bd68");
        int textColor = Color.parseColor("#30bd68");
        int buttonAndFeedbackBarColor =  Color.parseColor("#30bd68");
        int buttonAndFeedbackBarTextColor = Color.parseColor("#ffffff");
        int buttonColorPressed = Color.parseColor("#30bd68");
